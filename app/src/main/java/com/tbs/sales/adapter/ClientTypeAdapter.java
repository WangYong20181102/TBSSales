...
public class ClientTypeAdapter extends BaseAdapter {
    ...
    public ClientTypeAdapter(Context context, List<KeyValueDataBean> listClientType, int selectPosition) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.client_detail_edit_item_layout,parent,false);
